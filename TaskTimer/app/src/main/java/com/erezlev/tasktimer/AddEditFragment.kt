...
class AddEditFragment : Fragment() {
    ...
    /** -------------------------------------------- new version with using the ViewModel : --------------------------------------*/
    ...
    /** -------------------------------------------- old version before using the ViewModel : --------------------------------------*/
//    private fun saveTask() {
//        // Update the database if at least onw field has changed.
...
//        if (task != null) {
//            Log.d(TAG, "saveTask: updating ecisting task")
//
//            // Set new task's name.
