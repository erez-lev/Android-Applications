...
class MainActivity : AppCompatActivity(),
    ...
    // Whether or no the activity is in 2-pane mode
    // i.e. running in landscpae, or on a tablet.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (fragment != null) {
            // There was an exisiting fragment to edit a task, make sure the panes are set correctly.
            showEditPane()
        } else {
    ...
    private fun showEditPane() {
        ...
        // Hide the left hand pane, if in a single pane view
    ...
    private fun removeEditPane(fragment: Fragment? = null) {
        ...
        // Set the visibility on the right hand pane.
        taskDetailsContainer.visibility = if (mTwoPane) View.INVISIBLE else View.GONE
