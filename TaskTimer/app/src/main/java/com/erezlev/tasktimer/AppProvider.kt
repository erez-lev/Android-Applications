...
/** Constants: */
const val CONTENT_AUTHORITY = "com.erezlev.tasktimer.provider"
...
class AppProvider : ContentProvider() {
    ...
    private fun buildUriMatcher(): UriMatcher {
        ...
        // e.g content://com.erezlev.tasktimer.provider/Tasks
        matcher.addURI(CONTENT_AUTHORITY, TasksContract.TABLE_NAME, TASKS)

        // e.g content://com.erezlev.tasktimer.provider/Tasks/8
...
//            }
    ...
    override fun update(
        ...
        if (count > 0) {
            ...
            Log.d(TAG, "update: Setting norifyChange with $uri")
            context?.contentResolver?.notifyChange(uri, null)
        }
